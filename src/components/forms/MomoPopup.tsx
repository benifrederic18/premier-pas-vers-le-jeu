...
export default function MomoPopup({ open, onClose, info }: Props) {
  ...
  const whatsappUrl = info.momoWhatsapp
    ? `https://wa.me/${info.momoWhatsapp.replace(/\D/g, '')}?text=${whatsappText}`
    : '';
              ...
              <div className="mb-5 space-y-3">
                <div className="bg-white/5 border border-white/10 rounded-xl p-4 text-center">
                  ...
                  <p className="text-gray-400 text-xs leading-relaxed">
                    Notre équipe va vous contacter très prochainement pour vous indiquer comment finaliser votre paiement.
                  </p>
                </div>
                {info.montant && (

...
export default function FooterSection() {
  ...
  const activeSocials = socialIcons.filter((s) => social[s.key as keyof SocialLinks]);
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            {activeSocials.length > 0 && (
              <div className="flex items-center gap-3">
                {activeSocials.map((s) => (
                  <a
                    key={s.key}
                    href={social[s.key as keyof SocialLinks] || '#'}
                    target="_blank"
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-500 text-sm">
              ...
              <p>📞 95 95 91 00</p>
              {social.emailGmail && (
                <a href={`mailto:${social.emailGmail}`} className="text-gray-500 hover:text-orange-400 transition-colors block">
                  ✉️ {social.emailGmail}
                </a>
              )}
              <p>📍 Cotonou, Bénin</p>
